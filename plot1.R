...
## This is Project 1 of Course 4 - Exploratory Data Analysis, this produces plot 1 of 4 a histogram of Global Active Power
## by C. Bleile
...
hist(HHpowerSubset$Global_active_power, main="Global Active Power", xlab="Global Active Power (kilowatts)", ylab="Frequency", col="Red")
